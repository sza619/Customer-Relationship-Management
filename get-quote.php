...
if(isset($_POST['submit']))
{
	...
	$query=$_POST['query'];
	$pd=date('Y-m-d');
mysqli_query($con,"insert into prequest(name,email,contactno,company,wdd,seo,wm,others,query,posting_date) values('$name','$email','$contact','$company','$wdd','$seo','$wm','$other','$query','$pd')");
