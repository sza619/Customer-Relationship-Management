                                                        ...
                                                        <td><?php echo $row['email'];?></td>
                                                         <td><?php echo $row['mobile'];?></td>
                                                          ...
                                                          <form name="abc" action="" method="post">
                                                           <a href="edit-user.php?id=<?php echo $row['id'];?>" class="btn btn-primary btn-xs btn-mini">View and Edit</a> 
                                                           <a href="delete-user.php?id=<?php echo $row['id'];?>" class="btn btn-danger btn-xs btn-mini">Delete</a>
