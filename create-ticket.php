...
$querya = "insert into ticket(ticket_id,email_id,subject,task_type,prioprity,ticket,status,posting_date)  values('$tid','$email','$subject','$tt','$priority','$ticket','$st','$pdate')";
$a=mysqli_query($con,$querya);
if($a)
{
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">                                                                        
                                    <p  style="color:#FF0000"><?=$_SESSION['msg1'];?><?=$_SESSION['msg1']="";?></p>
                               <div class="form-group">                                        
									 ...
									 <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select  name="tasktype" class="form-control select" required>
                                                ...
                                                <option value="billing">Missing product</option>
                                                <option value="ot1">Damaged product</option>
                                                <option value="ot2">Replacement</option>
                                                <option value="ot3">Refund</option>
                                            </select>
                                           </div>
                                    </div>
                                ...
                                <div class="panel-footer">
                                    ...
                                    <!-- <a href=create.php class="btn btn-primary pull-right">Send</a> -->
                                </div>
                            </div>
                            </form>
